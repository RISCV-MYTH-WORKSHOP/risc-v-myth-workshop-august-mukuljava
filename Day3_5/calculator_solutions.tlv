...
\TLV
   |calc
      ...
      @2   
         $out[31:0] = $reset1 ? 32'b0 : ($op[1] ? ($op[0] ? $quot[31:0] : $prod[31:0]) : ($op[0] ? $diff[31:0] : $sum[31:0]));
         $reset1 = (!$valid) || $reset;
...
\TLV
   |calc
      ...
      @2   
         ...
         $out[31:0] = $reset ? 32'b0 : ($op == 3'b000 ? $sum:
                                       ($op == 3'b001 ? $diff:
                                       ($op == 3'b010 ? $prod:
                                       ($op == 3'b011 ? $quot:
...
\TLV
   ...
   |cpu
      ...
      @3
         ...
         //replacing @1 valid with @3 valid based on non-existence of $valid_taken_br
...
\TLV
   ...
   |cpu
      ...
      @2
         ...
         `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_addi $is_add $is_load $is_sb $is_sh $is_sw $start)
...
\TLV
   ...
   |cpu
      ...
      @3
         ...
         //create valid in shadow of load
